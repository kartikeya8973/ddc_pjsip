export PJDIR := /home/csemi/kartikeya/MYD-C8MMX/MYD-C8MMX-ISO-20200401/pjsip/pjproject-2.10
...
export APP_CC := aarch64-poky-linux-gcc  --sysroot=/home/csemi/kartikeya/MYD-C8MMX/MYD-C8MMX-ISO-20200401/03-Tools/myd_toolchain/sysroots/aarch64-poky-linux
export APP_CXX := aarch64-poky-linux-g++  --sysroot=/home/csemi/kartikeya/MYD-C8MMX/MYD-C8MMX-ISO-20200401/03-Tools/myd_toolchain/sysroots/aarch64-poky-linux
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	 -O2 -pipe -g -feliminate-unused-debug-types  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -fPIC\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_CXXFLAGS :=  -O2 -pipe -g -feliminate-unused-debug-types  $(APP_CFLAGS)
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-luuid -lm -lrt -lpthread  -lasound -lv4l2
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1  -O2 -pipe -g -feliminate-unused-debug-types  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -fPIC
export PJ_INSTALL_CXXFLAGS :=  -O2 -pipe -g -feliminate-unused-debug-types  $(PJ_INSTALL_CFLAGS)
